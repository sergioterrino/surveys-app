        ...
        <div className="flex flex-col items-center justify-between gap-2 bg-zinc-800 rounded-lg border p-3 text-center">
          ...
          <div className="flex items-center justify-around w-full mt-2">
            <button
              ...
              className="px-2 py-0.5 inline-flex items-center rounded-lg font-bold bg-indigo-700 hover:bg-indigo-800 "
            >
              <svg
            ...
            <button
              ...
              className="px-2 py-0.5 inline-flex items-center rounded-lg font-bold bg-blue-700 hover:bg-blue-800 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
