...
function SurveyCard({ survey, isAuth, removeSurvey }) {
  ...
  return (
    <>
      {isAuth ? (
        <div className="flex flex-col items-center justify-between gap-2 bg-zinc-800 rounded-lg shadow-2xl p-3 text-center">
          <h3 className="font-bold text-lg">{survey.title}</h3>
          <p className="text-sm">{survey.description}</p>
          <div className="flex items-center justify-around w-full mt-2">
            <button
              onClick={resultsSurvey}
              className="px-2 py-0.5 inline-flex items-center rounded-lg font-bold bg-indigo-700 hover:bg-indigo-800 shadow"
            >
              <svg
            ...
            <button
              ...
              className="px-2 py-0.5 inline-flex items-center rounded-lg font-bold bg-blue-700 hover:bg-blue-800 shadow"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <button
              ...
              className="px-2 py-0.5 rounded-lg font-bold bg-red-700 hover:bg-red-800 inline-flex items-center gap-1 shadow"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="flex flex-col items-center justify-between gap-2 bg-zinc-800 rounded-lg shadow-2xl p-3 text-center">
          ...
          <button
            ...
            className="px-2 py-0.5 pt-1 rounded-lg font-bold bg-indigo-700 hover:bg-indigo-800 inline-flex items-center gap-1 shadow"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
